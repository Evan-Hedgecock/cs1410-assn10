...
public class BinarySearchTreeTest {
    ...
    public void BinarySearchTreeInsertTest1() {
        ...
        for (int item : array) {
            count++;
            Assert.assertTrue(String.format("BST failed to insert %s and return true", item), intBst.insert(item));
    ...
    public void BinarySearchTreeInsertTest2() {
        ...
        for (int item : array) {
            Assert.assertFalse(String.format("BST failed to handle re-inserting %s and returning false", item), intBst.insert(item));
        }
    }
    ...
    @org.junit.Test
    public void BinarySearchTreeSearchTestStrings() {
        BinarySearchTree<String> stringBst = new BinarySearchTree<>();
        String[] array = {
                "mouse",
                "lion", "pear",
                "kite", "moose", "owl", "rabbit",
                "ant", "dog", "jump", "leaf", "net", "oak", "pig", "tree"
        };

        for (String item : array) {
            stringBst.insert(item);
            Assert.assertTrue(String.format("BST failed to find node %s", item), stringBst.search(item));
        }
    }
